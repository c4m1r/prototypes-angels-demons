...
export const UNIT_CONFIGS: Record<UnitType, UnitConfig> = {
  ...
  servant: {
    ...
    ascii: '✝', description: 'Строитель и ремонтник', isHero: false, abilities: [],
  },
  priest: {
    ...
    ascii: '†', description: 'Слабый начальный отряд', isHero: false, abilities: [],
  },
  angel: {
    ...
    ascii: '☨', description: 'Мощный одиночный юнит', isHero: false, abilities: [],
  },
  paladin: {
    ...
    ascii: '⚔', description: 'Ближний бой', isHero: false, abilities: [],
  },
  seraphim: {
    ...
    ascii: '✦', description: 'Дальний бой молниями', isHero: false, abilities: [],
  },
  archangel: {
  ...
  infernal: {
    ...
    attackSpeed: 1.1, movementSpeed: 85, evasion: 0.12,
    initialSquadSize: 3, maxSquadSize: 5, buildTime: 22,
    ascii: '♆', description: 'Дальний бой огнем', isHero: false, abilities: [],
  },
  archdemon: {
  ...
  zombie: {
    ...
    initialSquadSize: 1, maxSquadSize: 4, buildTime: 15,
    ascii: 'U', description: 'Медленный ближний бой', isHero: false, abilities: [],
  },
  lich: {
    name: 'Лич', cost: 72, health: 500, mana: 100, damage: 60, range: 200,
    attackSpeed: 1.0, movementSpeed: 60, evasion: 0.1,
    initialSquadSize: 1, maxSquadSize: 1, buildTime: 25,
    ascii: '☠', description: 'Маг нежити', isHero: false, abilities: [],
  },
  deathknight: {
  ...
  banshee: {
    ...
    initialSquadSize: 3, maxSquadSize: 5, buildTime: 22,
    ascii: '☤', description: 'Дальний бой', isHero: false, abilities: [],
  },
  overlord: {
  ...
  soldier: {
    ...
    initialSquadSize: 1, maxSquadSize: 4, buildTime: 15,
    ascii: 'M', description: 'Стрелковый отряд', isHero: false, abilities: [],
  },
  mech: {
    name: 'Мех', cost: 72, health: 800, mana: 0, damage: 100, range: 150,
    attackSpeed: 1.2, movementSpeed: 60, evasion: 0.05,
    initialSquadSize: 1, maxSquadSize: 1, buildTime: 25,
    ascii: '▣', description: 'Тяжелый мех', isHero: false, abilities: [],
  },
  tank: {
    name: 'Танк', cost: 80, health: 250, mana: 0, damage: 30, range: 50,
    attackSpeed: 1.0, movementSpeed: 55, evasion: 0.03,
    initialSquadSize: 4, maxSquadSize: 7, buildTime: 20,
    ascii: '▤', description: 'Тяжелый ближний бой', isHero: false, abilities: [],
  },
  artillery: {
    name: 'Артиллерия', cost: 100, health: 100, mana: 0, damage: 50, range: 250,
    attackSpeed: 1.5, movementSpeed: 40, evasion: 0.02,
    initialSquadSize: 3, maxSquadSize: 5, buildTime: 22,
    ascii: '◈', description: 'Дальний обстрел', isHero: false, abilities: [],
  },
  titan: {
